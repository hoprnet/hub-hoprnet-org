  ...
  '/staking/gno-airdrop': [
    {
      ...
      content: (
        <span>
          ...
          We also checked how many of your HOPR nodes were running at 90% uptime between Oct 1st - 30th
          <br />
    ...
    },
    {
      ...
      content: (
        <span>
          ...
          >
            how to generate deposits files here on the gnosis docs. Remember to provide withdrawal address while
            creating the validators. It will be a lot easier while creation than adding them later.
          </a>
        </span>
      ),
    },
    {
      id: 3,
      title: 'How to claim',
      content: `You have until November 15th to submit your validator(s) file. If you miss this deadline, you will have to wait until future distributions, which are first come, first served.`,
    },
    {
      id: 4,
      title: 'How many validators do I need to provide?',
      content: `Only new validators are eligible for these rewards. You should create the same number of new validators as GNO you are due to receive. Each validator can only receive 1 GNO, and if a validator already has GNO, it will not be able to recieve more. If you will provide more validators in the deposit file than you are eligible for, we take into account only the entries at the beginning of the deposit file and disregard the rest of the validators inside it.`,
    },
    {
      id: 5,
