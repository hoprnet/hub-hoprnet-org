...
const hubFaq: FaqData = {
  '/staking/gno-airdrop': [
    ...
    },
    {
      ...
      content:
        `If you are eligible for 1+ GNOs, it means that you should create a deposit file for that number of GNOs that you will receive. Each validator can use only exactly 1 GNO.`
    },
    {
      id: 5,
